...
const Blogs = () => {
    return (
        <div className='w-75'>
            <div >
                <h3 className='fw-bold text-slate-600 text-2xl'>How will you improve the performance of a React Application?</h3>
            ...
            <div >
                <h3 className='fw-bold text-slate-600 text-2xl'>What are the different ways to manage a state in a React application?</h3>
            ...
            <div >
                <h3 className='fw-bold text-slate-600 text-2xl'>How does prototypical inheritance work?</h3>
            ...
            <div >
                <h3 className='fw-bold text-slate-600 text-2xl'>Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h3>
                <p>juseState() is a so-called Hook. It's baked into React's core API and you use it to manage state in functional components. The way it works is like this: You pass in your initial state ([]) It returns an array with exactly 2 elements ([cart, setCart] = your current state and a state-setting function) You access the state with the first element and set it with the second element (which is a function)</p>
            </div>
            <div >
                <h3 className='fw-bold text-slate-600 text-2xl'>You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h3>
                <p>The search feature is implemented by using the filter() method. The filter() method creates a new array with all elements that pass the test implemented by the provided function. The filter() method does not change the original array. It returns a new array.</p>
            </div>
            <div >
                <h3 className='fw-bold text-slate-600 text-2xl'>What is a unit test? Why should write unit tests?</h3>
