    ...
    return (
        <div className='w-75 m-auto my-4'>
            <div className='blog shadow p-3 my-3' >
                <h3 className='fw-bold title'>How will you improve the performance of a React Application?</h3>
            ...
            <div className='blog shadow p-3 my-3' >
                <h3 className='fw-bold title'>What are the different ways to manage a state in a React application?</h3>
            ...
            <div className='blog shadow p-3 my-3' >
                <h3 className='fw-bold title'>How does prototypical inheritance work?</h3>
            ...
            <div className='blog shadow p-3 my-3' >
                <h3 className='fw-bold title'>Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h3>
            ...
            <div className='blog shadow p-3 my-3'>
                <h3 className='fw-bold title'>You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h3>
            ...
            <div className='blog shadow p-3 my-3' >
                <h3 className='fw-bold title'>What is a unit test? Why should write unit tests?</h3>
